...
echo"<script>alert('El usuario [ ".$idCliente." ]... no esta registrado')</script>";*/

$Data[0] = $_POST["idVeterinario"];
$Data[1] = $_POST["idCliente"];
$Data[2] = $_POST["txtMotivo"];
$Data[3] = $_POST["txtFecha"];
$Data[4] = $_POST["mascotaCli"];
$Data[5] = $_POST["txtHora"];

require_once('../modelo/modeloDoctor.php');
$oUsuario = new cUsuario();

$Result =$oUsuario->AgregarReserva($Data);

if($Result == 1){
	?>
<html lang="en">
	<head>
		<META http-equiv="Refresh" CONTENT="2; URL=/ListaReseva.php">

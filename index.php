...
<section class="nosotros -contenido" id="nosotros">
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
        ...
        <button class="carousel-control-prev flecha-1" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next flecha-1 " type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">

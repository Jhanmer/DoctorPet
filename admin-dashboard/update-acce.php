                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <img src="/imagenes2/<?php echo $imagenPropiedad.".jpg"; ?>" alt="imagen" class="update-imagen">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <input type="submit" class="btn btn-outline-warning btn-lg btn-block" value="Actualizar Accesorio"></input>

                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <?php endforeach ?>
                                <!-- Formulario -->
                                <form class="form form-vertical" method="POST" action="/admin-dashboard/crear-alimento.php" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <input type="submit" class="btn btn-outline-warning btn-lg btn-block" value="Registrar Producto"></input>

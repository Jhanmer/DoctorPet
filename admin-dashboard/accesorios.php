<?php
include('delete-accesorio.php');
//recibiendo los datos del registro
$db = fnConnect($con);

$querydata = "SELECT * FROM accesorio";
                    ...
                    <table class="table table-striped propiedades" id="table1">
                        ...
                        <tbody>
                            <?php while ($propiedad = mysqli_fetch_assoc($resultadoData)) : ?>
                                <tr>
                                    <td><?php echo $propiedad['idAccesorio']; ?></td>
                                    <td><?php echo $propiedad['nombre']; ?></td>
                                    <td><?php echo $propiedad['descripcion']; ?></td>
                                    <td><img src="/imagenes2/<?php echo $propiedad['imagen'] . ".jpg"; ?>" alt="imagen" class="imagen-tabla"></td>
                                    <td><?php echo $propiedad['precio']; ?></td>
                                    <td><?php echo $propiedad['stock']; ?></td>
                                    <td>
                                        <div class="acciones">
                                            <div class="acc-1">
                                                <a href="update-acce.php?idAccesorio=<?php echo $propiedad['idAccesorio']; ?>" class="btn btn-primary boton">
                                                    Actualizar</a>
                                            </div>
                                            <br>
                                            <form method="POST" >
                                                <div class="acc-1">
                                                    <input type="hidden" name="idAccesorio" class="btn btn-danger boton" value="<?php echo $propiedad['idAccesorio'] ?>">

<?php
include('delete-medicamento.php');
//recibiendo los datos del registro
$db = fnConnect($con);

$querydata = "SELECT * FROM medicamento";
                    ...
                    <table class="table table-striped propiedades" id="table1">
                        ...
                        <tbody>
                            <?php while ($propiedad = mysqli_fetch_assoc($resultadoData)) : ?>
                                <tr>
                                    <td><?php echo $propiedad['idMedicamento']; ?></td>
                                    <td><?php echo $propiedad['nombre']; ?></td>
                                    <td><?php echo $propiedad['descripcion']; ?></td>
                                    <td><img src="/imagenes3/<?php echo $propiedad['imagen'] . ".jpg"; ?>" alt="imagen" class="imagen-tabla"></td>
                                    <td><?php echo $propiedad['precio']; ?></td>
                                    <td><?php echo $propiedad['stock']; ?></td>
                                    <td>
                                        <div class="acciones">
                                            <div class="acc-1">
                                                <a href="update-medicamento.php?idMedicamento=<?php echo $propiedad['idMedicamento']; ?>" class="btn btn-primary boton">
                                                    Actualizar</a>
                                            </div>
                                            <br>
                                            <form method="POST" >
                                                <div class="acc-1">
                                                    <input type="hidden" name="idMedicamento" class="btn btn-danger boton" value="<?php echo $propiedad['idMedicamento'] ?>">

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $query = "INSERT INTO accesorio (nombre, descripcion, imagen, precio, stock) VALUES 
        ...
        if ($resultado) {
            ...
            header('Location: /admin-dashboard/accesorios.php?mensaje=Registrado Correctamente&registrado=1');
        }
    }
}

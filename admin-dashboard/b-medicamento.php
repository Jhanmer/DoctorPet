...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        /* Subida de Archivo */
        $carpetaImagenes1 = '../imagenes3/';
        //crear carpeta
        if(!is_dir($carpetaImagenes1)){
            mkdir($carpetaImagenes1);
        }
        //Generar nombre único
        $nombreImagen1 = md5(uniqid(rand(), true));

        //subir imagen
        move_uploaded_file($imagen['tmp_name'], $carpetaImagenes1.$nombreImagen1.".jpg");
   

        //Insertar en la base de datos
        $query = "INSERT INTO medicamento (nombre, descripcion, imagen, precio, stock) VALUES 
        ('$nombre', '$descripcion', '$nombreImagen1', '$precio', '$stock')";
        ...
        if ($resultado) {
            ...
            header('Location: /admin-dashboard/medicamentos.php?mensaje=Registrado Correctamente&registrado=1');
        }
    }
}

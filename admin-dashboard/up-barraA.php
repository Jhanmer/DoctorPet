...
if(!$id){
    header('Location: /admin-dashboard/alimentos.php');
}

$consulta = "SELECT * FROM alimento WHERE idAlimento = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($imagen['name']) { /* en caso de que la imagen no sea un string vacio  */
        ...
        $query = "UPDATE alimento SET nombre = '$nombre', descripcion = '$descripcion', imagen = '$nombreImagen' , precio = '$precio', stock = '$stock' 
        WHERE idAlimento = $id";
        ...
        if ($resultado) {
            ...
            header('Location: /admin-dashboard/alimentos.php?update=Actualizado Correctamente&registrado=1');
        }
    }
}

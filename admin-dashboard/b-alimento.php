...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $query = "INSERT INTO alimento (nombre, descripcion, imagen, precio, stock) VALUES 
        ...
        if ($resultado) {
            ...
            header('Location: /admin-dashboard/alimentos.php?mensaje=Registrado Correctamente&registrado=1');
        }
    }
}

...
if(!$id){
    header('Location: /admin-dashboard/medicamentos.php');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($imagen['name']) { /* en caso de que la imagen no sea un string vacio  */
        ...
        $query = "UPDATE medicamento SET nombre = '$nombre', descripcion = '$descripcion', imagen = '$nombreImagen' , precio = '$precio', stock = '$stock' 
        ...
        if ($resultado) {
            ...
            header('Location: /admin-dashboard/medicamentos.php?update=Actualizado Correctamente&registrado=1');
        }
    }
}
